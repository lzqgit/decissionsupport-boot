 ...
 * @描述：公安力量 - 实体类
 * @创建时间：2016-11-28下午05:25:33
 * @author liaow
 * @JDK：1.7
 */
@Entity
@Table(name = "public_security_force")
...
public class PublicSecurityForce {
	...
	private String institutionNum; // 机构代码
	...
	private String responsiblePhone; // 负责人联系方式
	...
	public PublicSecurityForce() {
		super();
	}

	public PublicSecurityForce(String institutionName, String institutionNum,
			...
			String longitude, String latitude, String institutionAddress,
